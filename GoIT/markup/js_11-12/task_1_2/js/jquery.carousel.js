(function( $ ){
    ...
    $.fn.carousel = function(params) {
        ...
        //calculation the width of carousel-container depending on quantity of vivsible elements
        var $widthElem = $('.carousel-element').css('width');
        $widthElem = parseInt($widthElem) + 25;

        var $widthContainer = options.count * $widthElem - 25;
        $('.carousel-container').css("width", $widthContainer);
        $('.carousel-hider').css("width", $widthContainer);
        ...
        $elems.find('img').each(function(){
            ...
            $(this).one('load', function(){
                $(this).addClass('carousel-img').animate({opacity: 1}, 500);
            });
        ...
        this.on('click', function(e) {
            ...
            if (($parent)&&($parent.hasClass('carousel-element'))) {
                if ((options.animate)&&($timerId)) {
                    stopAnimation();
                }
                ...
                var $newImg = $('<div class="carousel-large"><img src="'+ $parent.find('img').attr('src')+'" style= "width:'+ $widthImg +'px; max-height:'+ $heightImg +'px; margin-left:-'+ $marginLeftImg +'px; margin-top:-'+ $marginTopImg +'px"></div>');
                $('body').append($newImg);
