...
(function ($) {
	$.fn.html5lightbox = function (options) {
		...
		inst.options = $.extend({
			...
			nextimage: "img/lightbox-next.png",
			previmage: "img/lightbox-prev.png",
			closeimage: "img/lightbox-close.png",
			playvideoimage: "img/lightbox-playvideo.png",
			titlebgimage: "img/lightbox-titlebg.png",
			navarrowsprevimage: "img/lightbox-navprev.png",
			navarrowsnextimage: "img/lightbox-navnext.png",
			navarrowsalwaysshowontouch: true,
			navarrowsbottomscreenwidth: 479,
			closeonoverlay: true,
			alwaysshownavarrows: false,
			showplaybutton: true,
			playimage: "img/lightbox-play.png",
			pauseimage: "img/lightbox-pause.png",
			fullscreenmode: false,
			fullscreencloseimage: "img/lightbox-close-fullscreen.png",
			fullscreennextimage: "img/lightbox-next-fullscreen.png",
			fullscreenprevimage: "img/lightbox-prev-fullscreen.png",
			videobgcolor: "#fff",
			showtitle: true,
			titlestyle: "bottom",
	...
	$.fn.acHTML5VideoControls = function (skinFolder, parentInst, hidecontrols, hideplaybutton, defaultvolume) {
		...
		if (!isIPhone) {
			...
			$videoPlay.css({
				...
				"margin-left": -32,
				"margin-top": -32,
				"background-image": "url('" + skinFolder + "img/html5boxplayer_playvideo.png" + "')",
		...
		$videoBtnPlay.css({
			...
			height: BUTTON_SIZE + "px",
			cursor: "pointer",
			"background-image": "url('" + skinFolder + "img/html5boxplayer_playpause.png" + "')",
		...
		if (!isIPhone && ($videoObj.get(0).requestFullscreen || $videoObj.get(0).webkitRequestFullScreen || $videoObj.get(0).mozRequestFullScreen || $videoObj.get(0).webkitEnterFullScreen || $videoObj.get(0).msRequestFullscreen)) {
			...
			$videoFullscreen.css({
				...
				margin: Math.floor((BAR_HEIGHT - BUTTON_SIZE) / 2),
				cursor: "pointer",
				"background-image": "url('" + skinFolder + "img/html5boxplayer_fullscreen.png" + "')",
		...
		if (hd) {
			...
			$videoHD.css({
				...
				"background-image": "url('" +
					skinFolder + "img/html5boxplayer_hd.png" + "')",
	...
	$.fn.amazingcarousel = function (options) {
		...
		this.each(function () {
			...
			var defaultOptions = {
				...
				hoveroverlayimage: "img/hoveroverlay-64-64-0.png",
